...
export type IconName =
  | "check" | "copy" | "eye" | "eyeOff" | "download" | "refresh"
  | "arrow" | "bolt" | "cpu" | "cursor" | "key" | "shield"
  | "sun" | "moon" | "lock" | "info" | "image" | "camera"
  | "x" | "plus" | "settings" | "sliders";
...
export function Icon({ name, size = 18, stroke = 2, style }: IconProps) {
  const props = {
    width: size, height: size, viewBox: "0 0 24 24", fill: "none",
    stroke: "currentColor", strokeWidth: stroke, strokeLinecap: "round" as const,
    strokeLinejoin: "round" as const, style: { display: "block", flex: "none", ...style },
  };
  ...
  const paths: Record<IconName, React.ReactNode> = {
    ...
    eyeOff:   <><path d="M9.9 4.24A9.1 9.1 0 0 1 12 4c6.5 0 10 7 10 7a13.2 13.2 0 0 1-1.67 2.68" /><path d="M6.6 6.6A13.3 13.3 0 0 0 2 11s3.5 7 10 7a9 9 0 0 0 5.4-1.6" /><path d="M14.1 14.1a3 3 0 1 1-4.2-4.2" /><line x1="2" y1="2" x2="22" y2="22" /></>,
